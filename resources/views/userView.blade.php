  ...
  <a class=" btn modal-trigger" href="#modal1"><i class="material-icons">info</i></a>
        ...
        <div id="test3" class="col s12 queue-animate-bottom">
            ...
            <ul class="collection with-header" style="width: 100%; " >
                <li><div class="card medium">
                    <div class="card-image waves-effect waves-block waves-light">
                      <img class="activator" src="https://images.unsplash.com/photo-1552566626-52f8b828add9?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=1650&q=80">
                    </div>

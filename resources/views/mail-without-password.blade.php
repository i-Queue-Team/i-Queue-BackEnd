											...
											<div
												...
												<div class="txtTinyMce-wrapper"
													...
													<p
														...
														<span style="font-size: 30px; color: #2b303a;"><strong>¡Hola de nuevo,
                                                            {{$name}}!</strong></span></p>
												</div>
											</div>
											<!--[if mso]></td></tr></table><![endif]-->
											...
											<div
												...
												<div class="txtTinyMce-wrapper"
													...
													<p
														...
														<span style="color: #808389; font-size: 15px;">¡Nos alegra verte de nuevo por aqui!</span></p>
													<p
														style="margin: 0; font-size: 15px; line-height: 1.5; text-align: center; word-break: break-word; mso-line-height-alt: 23px; margin-top: 0; margin-bottom: 0;">
														<span style="color: #808389; font-size: 15px;"> ¿Sabias que teniamos una app?.
														</span><span
															style="color: #808389; font-size: 15px;">¡Ahorra tiempo escribiendo tu email escaneando el codigo qr!</span></p>
													<p
												...
												<!--[if mso]><table width="100%" cellpadding="0" cellspacing="0" border="0" style="border-spacing: 0; border-collapse: collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;"><tr><td style="padding-top: 15px; padding-right: 10px; padding-bottom: 0px; padding-left: 10px" align="center"><v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="{{$url}}" style="height:46.5pt;width:243pt;v-text-anchor:middle;" arcsize="97%" stroke="false" fillcolor="#1aa19c"><w:anchorlock/><v:textbox inset="0,0,0,0"><center style="color:#ffffff; font-family:Tahoma, sans-serif; font-size:16px"><![endif]--><a
													...
													target="_blank"><span
														style="padding-left:30px;padding-right:30px;font-size:16px;display:inline-block;letter-spacing:undefined;"><span
															style="font-size: 16px; margin: 0; line-height: 2; word-break: break-word; mso-line-height-alt: 32px;"><strong>¡Inicia sesion para Supervisar tu turno!</strong></span></span></a>
